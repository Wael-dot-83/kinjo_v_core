    ...
    class DataTable {
        ...
        _wrap() {
            ...
            if (this.searchable) {
                ...
                bar.innerHTML = `<div class="input-group input-group-sm" style="max-width:240px;">
                    ...
                    <input type="search" class="form-control datatable-search" placeholder="Search...">
                </div>`;
        ...
        _sort(col) {
            ...
            this._allRows.sort((a, b) => {
                ...
                const cmp = !isNaN(na) && !isNaN(nb) ? na - nb : va.localeCompare(vb, 'en');
        ...
        _renderPager(pages, total, start, count) {
            ...
            info.textContent = `${start + 1}-${start + count} of ${total}`;
            p.appendChild(info);
            ...
            nav.appendChild(mkBtn('Previous', this.currentPage - 1, this.currentPage === 1));
            ...
            nav.appendChild(mkBtn('Next', this.currentPage + 1, this.currentPage === pages));
            p.appendChild(nav);
        }
