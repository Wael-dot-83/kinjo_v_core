...
const defaultEnglishTranslations = {
  ...
  dashboard: {
    ...
    trend_no_baseline_tooltip: "Baseline comparison requires historical records from the previous reporting period.",
...
const defaultArabicTranslations = {
  ...
  dashboard: {
    ...
    active_users: "المستخدمون الذين سجلوا الدخول اليوم",
    ...
    trend_no_baseline_tooltip: "تتطلب المقارنة وجود بيانات تاريخية مسجلة من فترة التقرير السابقة.",
    dismiss_alert: "تجاهل التنبيه",
    export_chart: "تصدير المخطط",
