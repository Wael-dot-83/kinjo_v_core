...
function renderKpiExplanations(kpis) {
  ...
  explainView.innerHTML = dashboardTemplate(`
    <div class="kpi-explain-intro">
      ...
      تساعد مؤشرات الأداء الرئيسية في فهم مستوى أداء الحضانات من حيث الحضور، الالتزام بالتقارير، السلامة، الإشراف، التدريب، استغلال السعة، وجودة الحوكمة. يتم احتساب هذه المؤشرات بناءً على البيانات المسجلة في النظام خلال الفترة المحددة، وتساعد الإدارة على تحديد الأولويات واتخاذ الإجراءات المناسبة.
    </div>
    <input
      type="search"
