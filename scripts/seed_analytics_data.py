...
# Kindergarten names
KG_NAMES = [
    "حضانة الأمل", "حضانة النور", "حضانة الزهور", "حضانة الربيع", "حضانة السعادة",
    "حضانة الحنان", "حضانة الأطفال", "حضانة المستقبل", "حضانة الإبداع", "حضانة النجاح",
    "حضانة الورود", "حضانة القمر", "حضانة الشمس", "حضانة النجمة", "حضانة الحب"
]
