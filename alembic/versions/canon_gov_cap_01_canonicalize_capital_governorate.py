...
def upgrade() -> None:
    ...
    for table in _TABLES:
        ...
        print(f"[canonicalize-capital] {table}.governorate: {result.rowcount} row(s) updated")
...
def downgrade() -> None:
    ...
    for table in _TABLES:
        ...
        print(f"[canonicalize-capital:down] {table}.governorate: {result.rowcount} row(s) updated")
