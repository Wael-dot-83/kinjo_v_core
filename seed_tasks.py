...
def seed_tasks():
    ...
    try:
        ...
        if not manager1:
            ...
            print(f"   [+] Manager (Al Amal): manager1 / Manager123!")
        else:
        ...
        if not manager2:
            ...
            print(f"   [+] Manager (Al Noor): manager2 / Manager123!")
        else:
        ...
        if not supervisor1:
            ...
            print(f"   [+] Supervisor (Al Amal): supervisor1 / Supervisor123!")
        else:
        ...
        if not supervisor2:
            ...
            print(f"   [+] Supervisor (Al Noor): supervisor2 / Supervisor123!")
        else:
        ...
        print("   │ Supervisor  │ supervisor2         │ Supervisor123!   │")
