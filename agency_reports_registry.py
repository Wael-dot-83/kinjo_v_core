...
AGENCY_REPORT_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "mopic": {
        ...
        "description_ar": "تقارير فجوات الوصول وأولويات المحافظات وجاهزية السعة الاستيعابية والاستثمار.",
        "icon": "bi-diagram-3",
        "reports": {
            "service_access_gaps": {
                "title_ar": "فجوات الوصول لخدمات الطفولة المبكرة والمناطق المحرومة",
                "title_en": "Early childhood service access gaps & unserved areas",
                "description_ar": "مقارنة بين توزيع الأطفال وتوافر الحضانات النشطة، لتحديد المناطق ذات الطلب العالي والمناطق المحرومة من الخدمة.",
                "status": "ready",
                "privacy_level": "aggregated_only",
                "default_geography_basis": "parent_residence",
                "filters": ["governorate", "city", "aggregation_level", "geography_basis"],
            ...
            "regional_capacity_readiness": {
                "title_ar": "الجاهزية والسعة الاستيعابية الإقليمية والاستثمارية",
                "title_en": "Regional capacity, occupancy & investment readiness",
                "description_ar": "تحليل الطاقة الاستيعابية الصفّية، أعداد المسجلين، معدلات الإشغال، والسعة المتاحة للتوسع حسب المحافظة واللواء.",
                "status": "ready",
                "privacy_level": "aggregated_only",
                "default_geography_basis": "kindergarten_location",
                "filters": ["governorate", "city", "aggregation_level"],
                "exports": ["csv", "json"],
                "data_sources": ["Kindergarten", "Class", "EnrollmentApplication"],
            },
            "development_investment_priorities": {
                "title_ar": "أولويات الاستثمار والتنمية حسب المحافظات",
                "title_en": "Governorate development & investment priorities index",
                "description_ar": "مؤشر مركب يرتب المحافظات حسب أولوية الاستثمار التنموي، بالدمج بين العجز في السعة ونسبة الأطفال غير المخدومين.",
                "status": "ready",
                "privacy_level": "aggregated_only",
                "default_geography_basis": "national",
                "filters": ["governorate", "aggregation_level"],
                "exports": ["csv", "json"],
                "data_sources": ["Child", "ParentProfile", "Kindergarten", "Class"],
            },
        },
    },
}
